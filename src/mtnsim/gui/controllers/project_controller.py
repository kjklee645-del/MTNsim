...
class ProjectController:
    ...
    def _build_empty_starter_scenario_data(self, *, project_name: str, scenario_name: str, description: str) -> dict:
        return {
            'scenario': {
                'name': scenario_name,
                'description': description,
    ...
    def _build_starter_scenario_data(self, *, project_name: str, scenario_name: str, description: str, inspection: SumoProjectInspection) -> dict:
        vehicle_types = inspection.vehicle_types or ['DEFAULT_VEHTYPE']
