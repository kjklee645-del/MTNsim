...
def directional_gain_db(
    target_position: tuple[float, float] | tuple[float, float, float],
    ...
    *,
    ...
    target_dx = target_position[0] - vehicle_position_xy[0]
    target_dy = target_position[1] - vehicle_position_xy[1]
